...
function lockQuote(){
    if (!locked){
        ...
        locked = true;
        document.querySelector<HTMLButtonElement>('.btn-1')!.setAttribute('disabled', 'true');
        document.getElementById('categoryText')!.innerText = `Category: ${quotes[currentQuoteIndex].category}!`;
    }
}
